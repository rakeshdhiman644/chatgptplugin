...
function my_plugin_display_form(){
	add_menu_page( 'My Form', 'My Form', 'manage_options', 'my-form', 'my_plugin_form', 'dashicons-admin-generic', 6 );
}
...
add_shortcode( 'simple_form_ajax', 'simple_form_ajax_form_shortcode' );
...
//return $answer;
		...
		echo json_encode( array('succress'=> $answer) );
